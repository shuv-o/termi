...
function SidebarNav({
    ...
    const items: NavItem[] = [
        ...
        { id: 'security', label: 'Security', icon: Shield },
        {
            ...
            label: 'Passkeys',
            icon: Fingerprint,
            badge: passkeys.length || undefined,
        },
...
function PasskeyRow({ passkey, onDelete }: { passkey: Passkey; onDelete: (id: string) => void }) {
    ...
    const lastUsed = passkey.lastUsedAt
        ...
        : 'Never';
    const created = new Date(passkey.createdAt).toLocaleDateString(undefined, {
        month: 'short',
        day: 'numeric',
        year: 'numeric',
    });
        ...
        try {
            ...
            try {
                ...
                if (err instanceof Error) {
                    if (timedOut)
                        throw new Error(
                            'Passkey setup timed out — check for a system dialog on your screen',
                        );
                    ...
                    if (err.name === 'SecurityError')
                        throw new Error('Security error — ensure you are on a secure origin');
                }
            ...
            {recoveryCodes.length > 0 && (
                <div className="mb-6 p-5 rounded-xl bg-yellow-500/5 border border-yellow-500/30">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                        Store these securely. Each code can only be used once and won&apos;t be
                        shown again.
                    </p>
                                        ...
                                        <div className="space-y-4">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                ...
                                                >
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        A 6-digit code sent to your email on each
                                                        login.
                                                    </p>
                                                </button>
                                            </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <Button
                                                    ...
                                                    disabled={
                                                        verifyCode.length !== 6 || enabling2FA
                                                    }
                                                    className="flex-1"
                                                >
                                                    {enabling2FA ? (
                                    ...
                                    {showDisable && (
                                        <div className="space-y-3">
                                            <div className="flex items-start gap-3 p-3 rounded-xl bg-destructive/10 border border-destructive/20 text-sm text-destructive">
                                                ...
                                                Disabling 2FA reduces your account security. Confirm
                            ...
                            >
                                {loadingPasskeys ? (
                                    ...
                                    <div className="mb-4 flex items-center gap-3 p-4 rounded-xl bg-secondary/50 border border-border/50 text-sm text-muted-foreground">
                                        ...
                                        No passkeys registered. Add one to enable passwordless
                                ...
                                {showAddPasskey ? (
                                    <div className="space-y-3 p-4 rounded-xl bg-secondary/50 border border-border">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Identify the device — e.g. &quot;MacBook Touch ID&quot;
                                            or &quot;iPhone Face ID&quot;.
                                        </p>
                                        <Input
                                            type="text"
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            >
                                                {addingPasskey ? (
                                                    ...
                                                    <>
                                                        <Fingerprint className="w-4 h-4" /> Create
                                                        Passkey
                                                    </>
                                                )}
                                            </Button>
                            ...
                            >
                                {user?.isGoogleUser ? (
                                    <div className="space-y-4">
                                        ...
                                        >
                                            {user.hasMasterKey ? (
                                                <>
                                                    ...
                                                    Encryption passphrase is set
                                                </>
                                            ) : (
                                                <>
                                                    <AlertTriangle className="w-4 h-4 shrink-0" />{' '}
                                                    No passphrase set — server connections
                                                    won&apos;t work
                                                </>
                                            )}
                                        </div>
                                        <p className="text-xs text-muted-foreground">
                                            Your server credentials are encrypted with your
                                            passphrase. You enter it each time you sign in with
                                            Google.
                                        </p>
                                        <form
                                        ...
                                        >
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    setEncryptionPassphrase(e.target.value)
                                                }
                                                className="bg-secondary border-border"
                                                required
                                                minLength={8}
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    setEncryptionConfirm(e.target.value)
                                                }
                                            ...
                                            />
                                            {encryptionConfirm &&
                                                encryptionPassphrase !== encryptionConfirm && (
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Credentials are encrypted with a key derived from your
                                            password. Changing your password automatically
                                            re-encrypts all credentials. If you reset a forgotten
                                            password, stored credentials are permanently lost.
                                        </p>
                                    </div>
                                )}
                            </Section>
                            ...
                            >
                                <div className="space-y-4">
                                        ...
                                        {pushSubscribed ? (
                                            <>
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-muted-foreground mt-0.5">
                                                        This device will receive server alert
                                                        notifications
                                                    </p>
                                                </div>
                                            </>
                                    ...
                                    <div className="flex items-start gap-2 text-xs text-muted-foreground/60">
                                        ...
                                        Notifications are per-device. Enable separately on each
                                        device. Alert rules are configured per server in the server
                                        details page.
                                    </div>
                                </div>
                            </Section>
                            ...
                            >
                                ...
                                {authSessions.filter((s) => !s.isCurrent).length > 0 && (
                                    <div className="mt-4 flex items-center justify-between pt-4 border-t border-border/50">
                                        <p className="text-xs text-muted-foreground">
                                            {authSessions.filter((s) => !s.isCurrent).length} other
                                            device
                                            {authSessions.filter((s) => !s.isCurrent).length !== 1
                                                ? 's'
                                                : ''}{' '}
                                            signed in
                                        </p>
                                            ...
                                            <div className="flex items-start justify-between gap-4">
                                                <div>
                                                    ...
                                                    <p className="text-xs text-muted-foreground mt-1">
                                                        Permanently deletes all stored servers and
                                                        credentials. You&apos;ll need to re-add
                                                ...
                                                {!showEncryptionResetConfirm && (
                                                    <Button
                                                        ...
                                                        size="sm"
                                                        onClick={() =>
                                                            setShowEncryptionResetConfirm(true)
                                                        }
                                            ...
                                            {showEncryptionResetConfirm && (
                                                <div className="mt-4 pt-4 border-t border-red-500/20 space-y-3">
                                                    <p className="text-sm text-red-300 font-medium">
                                                        This will permanently delete all your stored
                                                        servers and credentials. This cannot be
                                                        undone.
                                                    </p>
                                                    <div className="flex gap-2">
                                                        <Button
                                    ...
                                    {!user?.isGoogleUser && (
                                        <div className="p-4 rounded-xl border border-border/50 bg-secondary/30">
                                            <p className="text-sm text-muted-foreground">
                                                Password-based accounts use a login-derived
                                                encryption key. Encryption reset is only available
