...
export function UnverifiedBanner({
    ...
    return (
        <div className="mb-6 flex max-w-4xl items-center justify-between gap-4 rounded-xl border border-warning/30 bg-warning/10 px-4 py-3 text-sm">
...
export function RecoveryCodesPanel({
    ...
    return (
        <div className="mb-6 max-w-4xl rounded-xl border border-warning/30 bg-warning/5 p-5">
            <div className="flex items-center gap-2 mb-3">
                <AlertTriangle className="w-5 h-5 text-warning" />
                <h2 className="font-semibold text-warning">Save your recovery codes</h2>
            </div>
